...
export const editFileName = (request: Request, file: Express.Multer.File, callback): void => {
...
export const imageFileFilter = (request: Request, file: Express.Multer.File, callback): void => {
...
export const excelFileFilter = (request: Request, file: Express.Multer.File, callback): void => {
