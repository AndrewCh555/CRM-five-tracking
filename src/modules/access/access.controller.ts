...
export class AccessController {
  ...
  @UseGuards(RolesGuard)
  @CheckAbilities({ action: MethodsEnum.Update, subject: Access })
  @ApiOperation({ description: 'Downgrade admin to user' })
  public async downgradeAdmin(@Param('id', ParseUUIDPipe) userId: string): Promise<void> {
    await this.accessService.updateAdminToUser(userId);
  }
}
